...
ax.plot(gaussian_filter1d(scores_sentence_space_w2v_own[:, 9], 18), c="blue", label="W2V Partial Fit Sentence Space | Mean BAC: %.3f" % np.mean(scores_sentence_space_w2v_own[:, 9]), ls="--")
