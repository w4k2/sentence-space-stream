...
fig, ax = plt.subplots(1, 1, figsize=(8, 6/1.618))
...
plt.tight_layout()
plt.savefig("figures/1_extractor.png", dpi=200, bbox_inches='tight')
plt.savefig("figures/1_extractor.eps", dpi=200, bbox_inches='tight')
plt.savefig('foo.png')