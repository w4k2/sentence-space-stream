...
ref_extractors_files = ["scores_glove_pca100_2c.npy", "scores_w2v_pre_pca100.npy", "scores_MiniLM_classes_fixed.npy", "scores_tfidf_2c.npy"]
...
for extractor_id, extractor in enumerate(ref_extractors):
    ...
    ax[extractor_id].plot(gaussian_filter1d(scores_sentence_space_glove[:, 9], 9), c="red", label="[~%.3f] SSS" % np.mean(scores_sentence_space_glove[:, 9]))
