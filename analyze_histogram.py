...
ax[1].plot(gaussian_filter1d(scores_sentence_space_glove_h50[:, 9], 9), c="blue", label="Glove Sentence Space 300x50  | Mean BAC: %.3f" % np.mean(scores_sentence_space_glove_h50[:, 9]))
ax[1].plot(gaussian_filter1d(scores_sentence_space_glove_h100[:, 9], 9), c="limegreen", label="Glove Sentence Space 300x100 | Mean BAC: %.3f" % np.mean(scores_sentence_space_glove_h100[:, 9]))
ax[1].plot(gaussian_filter1d(scores_sentence_space_glove[:, 9], 9), c="red", label="Glove Sentence Space 300x200 | Mean BAC: %.3f" % np.mean(scores_sentence_space_glove[:, 9]))
